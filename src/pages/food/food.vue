  ...
  <div class="food_container">
    ...
    <section class="sort_container">
      ...
      <div class="sort_item" :class="{choose_type:sortBy=='food'}">
        <div class="sort_item_container" @click="chooseType('food')">
          <div class="sort_item_border">
            <span :class="{categoty_title:sortBy=='food'}">{{foodTitle}}</span>
            <svg
              width="10"
              height="10"
        ...
        <transition-group name="showlist" v-show="category">
          <section v-show="sortBy == 'food'" class="category_container sort_detail_type" :key="1">
      ...
      <div class="sort_item" :class="{choose_type:sortBy == 'sort'}">
        ...
        <transition-group name="showlist">
          <section v-show="sortBy == 'sort'" class="sort_detail_type" :key="4">
      ...
      <div class="sort_item" :class="{choose_type:sortBy == 'activity'}">
        ...
        <transition-group name="showlist">
          <section v-show="sortBy == 'activity'" class="sort_detail_type filter_container" :key="5">
